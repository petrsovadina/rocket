...
function IconLogo({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      ...
      className={cn('h-4 w-4 text-black dark:text-white', className)}
      {...props}
    >
      <g transform="matrix(1,0,0,1,-40891.6,-23174.9)">
        <g id="Artboard11" transform="matrix(3.6923,0,0,3.08368,-102309,-48202.5)">
          <rect x="38783.6" y="23146.8" width="292.501" height="350.231" style={{ fill: 'none' }} />
          <g transform="matrix(0.763509,0.914202,-0.763509,0.914202,27021.2,-33598.5)">
            <g>
              <g transform="matrix(2.97212,0,0,2.97212,-76772.4,-45875.3)">
              ...
              <g transform="matrix(2.09252,0,0,2.09252,-42530.4,-25270.4)">
